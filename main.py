...
class SpriteKind:
    ...
    CCTV = SpriteKind.create()
    grassblock = SpriteKind.create()
def xy():
    BLO_CK.set_velocity(0, 200)

def on_on_overlap(sprite, otherSprite):
    global BLO_CK
    info.set_life(3)
    BLO_CK = sprites.create(assets.image("""
        GRASS
        """), SpriteKind.grassblock)
    xy()
...
scaling.scale_by_pixels(myCorg, 5, ScaleDirection.HORIZONTALLY, ScaleAnchor.TOP)
scaling.scale_by_pixels(myCorg, 5, ScaleDirection.VERTICALLY, ScaleAnchor.TOP)
CAMERA = sprites.create(img("""
        ...
        """),
    SpriteKind.CCTV)
animation.run_image_animation(CAMERA,
    [img("""
            . . . . . . . . . . . . . . . .
            . . . . . . . . . . . . . . . .
            . . . . . . . . . . . . . . . .
...
door1 = sprites.create(img("""
        ...
        """),
    SpriteKind.door)
door1.set_position(140, 100)
scaling.scale_by_pixels(door1, 10, ScaleDirection.HORIZONTALLY, ScaleAnchor.TOP)
scaling.scale_by_pixels(door1, 10, ScaleDirection.VERTICALLY, ScaleAnchor.TOP)
CAMERA.set_position(6, 4)

def on_forever():
    pause(5000)
    BLO_CK.set_position(118, 94)
forever(on_forever)
